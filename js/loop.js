function gameloop(that){
    ...
    that.player.r_generators[0].amount += ((that.player.r_generators[1].amount * that.player.r_generators[1].mult * that.player.mainupgrade.current_multiplier) * diff) / 10
    ...
    that.player.g_generators[0].amount += ((that.player.g_generators[1].amount * that.player.g_generators[1].mult * that.player.mainupgrade.current_multiplier) * diff) / 10
    ...
    that.player.b_generators[0].amount += ((that.player.b_generators[1].amount * that.player.b_generators[1].mult * that.player.mainupgrade.current_multiplier) * diff) / 10
